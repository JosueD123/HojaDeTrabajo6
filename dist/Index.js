...
app.put("/users/:dpi", authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    users[userIndex] = Object.assign(Object.assign(Object.assign(Object.assign({}, users[userIndex]), (name !== undefined && { name })), (email !== undefined && { email })), (password !== undefined && { password: yield bcrypt_1.default.hash(password, 10) }));
